...
function toggleMonthFilter(){const w=$('uniMonthWrap'),q=$('uniQuickTypeWrap'),qb=$('uniQuickTypeBox');const monthView=st.view==='timeline'||st.view==='calendar';const typeView=st.view==='card'||st.view==='table';if(w)w.hidden=!monthView;if(q)q.hidden=!typeView;if(qb&&!typeView)qb.hidden=true}
